...
def load_and_enqueue(sess,enqueue_op,coord,generator,image1,image2):
	while not coord.should_stop():
		train_data = generator.next()
		sess.run(enqueue_op, feed_dict={image1: train_data[0],image2 :train_data[1]})