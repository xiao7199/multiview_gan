...
parser.add_argument('--sample_freq', dest='sample_freq', type = int, default= 500, help='train, test')
...
parser.add_argument('--queue_capacity', dest='queue_capacity', type=int, default=500, help='queue capacity')
parser.add_argument('--queue_pre_load_num', dest='queue_pre_load_num', type=int, default=100, help='queue_pre_load_num')
